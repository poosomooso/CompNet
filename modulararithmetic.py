...
#
    ...
    def __invert__(self):
        " returns (1 / self) % self.MOD"
        #         ********** <-- result is an integer mod self.MOD,
        #                        not a fraction!!!
        #                     
        # This implementation algorithm is the Extended Euclidian Algorithm.
    ...
    def __pow__(self,other):
        ...
        return self.__class__(pow(int(self),int(other),self.MOD))
